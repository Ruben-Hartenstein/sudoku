...
Damit man das Sudokugitter ausfüllen kann sind zu Spielbeginn einige Ziffern vorgegeben. Mithilfe dieser Ziffern ist es möglich mit den gerade erklärten Regeln das ganze Sudokugitter zu füllen. \cite{sudopedia_2022}
...
Insgesamt gibt es über 20 Strategien die bei schweren Sudokus angewendet werden können. Zum Teil sind die Strategien für das menschliche Auge schwer zu entdecken und auch schwer zu erläutern. Wichtig bei diesen schweren Strategien ist eine gewissenhafte Ausführung der Kandidaten-Notation.\cite{martin}
